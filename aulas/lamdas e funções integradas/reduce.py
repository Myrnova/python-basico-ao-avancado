...
A função reduce(), funciona da seguinte forma:
    ...
    Passo 2: res2 = f(res1, a3) # Aplica a função passando o resultado do passo 1 mais o terceiro elemento e guarda em res2.
    ...
    Passo n: resn = f(res, an)

Ou seja, em casa passo ela aplica a função passando como primeiro argumento o resultado da aplicação anterior. No final, reduce() 
